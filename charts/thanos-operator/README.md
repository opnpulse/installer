...
| manager.image.repository                         |                                                                                                                 | <code>quay.io/thanos/thanos-operator</code>                                 |
| manager.image.tag                                |                                                                                                                 | <code>main</code>                                                           |
...
| thanosRuler.enabled                              |                                                                                                                 | <code>false</code>                                                          |
| thanosRuler.storage.size                         |                                                                                                                 | <code>2Gi</code>                                                            |
| thanosRuler.additionalVolumeMounts               |                                                                                                                 | <code>[]</code>                                                             |
| thanosRuler.additionalVolumes                    | - mountPath: /etc/thanos/certs name: thanos-certs readOnly: true                                                | <code>[]</code>                                                             |
| thanosRuler.queryURL                             | - name: thanos-certs secret: secretName: tls-ssl-minio items: - key: public.crt path: public.crt                | <code>http://thanos-operator-query.monitoring.svc.cluster.local:9090</code> |
| objectStorage.bucket                             |                                                                                                                 | <code>""</code>                                                             |
| objectStorage.endpoint                           |                                                                                                                 | <code>""</code>                                                             |
