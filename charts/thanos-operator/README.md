...
| thanosRuler.additionalArgs                       |                                                                                                                 | <code>[]</code>                               |
| thanosRuler.additionalVolumeMounts               | - --query.config-file=/etc/ruler/query.yaml - --remote-write.config-file=/etc/ruler-rw/remote-write.yaml        | <code>[]</code>                               |
| thanosRuler.additionalVolumes                    | - mountPath: /etc/thanos/certs name: thanos-certs readOnly: true                                                | <code>[]</code>                               |
| thanosRuler.monitoringClusterBaseURL             | - name: thanos-certs secret: secretName: tls-ssl-minio items: - key: public.crt path: public.crt                | <code>""</code>                               |
