...
$ helm repo update
$ helm search repo appscode/thanos-operator --version=v2026.6.2
$ helm upgrade -i thanos-operator appscode/thanos-operator -n kubeops --create-namespace --version=v2026.6.2
```
...
```bash
$ helm upgrade -i thanos-operator appscode/thanos-operator -n kubeops --create-namespace --version=v2026.6.2 --set manager.replicas=1
```
...
```bash
$ helm upgrade -i thanos-operator appscode/thanos-operator -n kubeops --create-namespace --version=v2026.6.2 --values values.yaml
```
